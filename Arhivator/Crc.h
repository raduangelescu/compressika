#ifndef M_CRC32
#define M_CRC32
#pragma warning( disable : 4293 ) // O chestie urata pe care o sa incerc sa o scot.. desi e al drq de naspa :))
/*
 CRC definitii:
 CRC_NAME		- Numele algoritmului .. destul de neimportant
 CRC_WIDTH	- numarul de biti rezultat din hash 
 CRC_POLY		- polinomul folosit , (truncat) (0x8005 = x^16+x^3+1)
 CRC_INIT		- restul initial 
 CRC_REFIN	- vrei sa aiba data reflectata?
 CRC_REFOUT	- vrei sa aiba restul reflectat?
 CRC_XOROUT	- versiunea finala XOR
*/
#define   CRC_NAME		  "CRC-32" //momentan asta e cel mai folosit la fisiere
#define   CRC_WIDTH		  32
...
/*________________________________________________________________
	Templateuri pentru generare de tabel
_________________________________________________________________*/
//practic aici desfacem bucla intr-un template recursiv
// la treaba cu RESULT= primim kk de warning daca nu e desablat
...
//in REFLECT:RESULT avem valorile lui W si a bitilor cei mai nesemnificativi reflectati
template<unsigned int W, unsigned int b>
class REFLECT
{
public:
...
// TABLE_ENTRY::RESULT pastram accesul la lookuptable la index
// tot while recursivizat
